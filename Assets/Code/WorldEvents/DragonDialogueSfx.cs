...
/// <summary>
/// Plays the optional SFX authored on a <see cref="DragonDialogueLine"/> (volume only, fixed pitch).
/// </summary>
public static class DragonDialogueSfx
{
	static Feedbacks _host;
	static PlaySFXFeedback _sfx;

	public static void PlayLine( DragonDialogueLine line )
	{
	...
	static void EnsureHost()
	{
		...
		GameObject go = new GameObject( "[DragonDialogueSfx]" );
