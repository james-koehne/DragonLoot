...
public class DebugLoggingSection : DebugOverlaySection
{
	...
	public void Draw()
	{
		...
		def.disableTreasureSpawning = GUILayout.Toggle( def.disableTreasureSpawning, "Disable Treasure Spawning" );
		def.disableTutorials = GUILayout.Toggle( def.disableTutorials, "Disable Tutorials" );
#if UNITY_EDITOR
