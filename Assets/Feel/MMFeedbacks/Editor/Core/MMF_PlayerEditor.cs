...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_PlayerEditor : Editor
	{
		...
		protected SerializedProperty _mmfeedbacksIgnoreActiveCheck;
		...
		protected virtual void Initialization()
		{
			...
			_mmfeedbacksIgnoreActiveCheck = serializedObject.FindProperty( "IgnoreActiveCheck" );
		...
		protected virtual void DrawSettingsDropDown()
		{
			...
			if ( _settingsMenuDropdown )
			{
				...
				EditorGUILayout.PropertyField( _mmfeedbacksIgnoreActiveCheck );
