Shader "DragonLoot/Build Ghost"
{
	Properties
	{
		_BaseColor ("Color", Color) = (0.35, 0.75, 1, 0.4)
		_RimColor ("Rim Color", Color) = (0.55, 1.1, 1.2, 1)
		_CoreColor ("Core Color", Color) = (0.05, 0.15, 0.25, 1)
